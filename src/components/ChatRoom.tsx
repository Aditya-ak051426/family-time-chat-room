...
const ChatRoom = ({ username }: ChatRoomProps) => {
  ...
  const fetchMessages = async () => {
    try {
      ...
      toast({
        ...
        description: "Could not load chat history. You may need to create the messages table in Supabase.",
        variant: "destructive"
      });
    }
  };
  ...
  const addMessage = async (text: string) => {
    try {
      ...
      toast({
        title: "Send Error", 
        description: "Could not send message. Make sure the messages table exists in Supabase.",
        variant: "destructive"
      });
    }
  };
